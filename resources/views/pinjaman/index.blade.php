                    ...
                    <div class="row">
                        <div class="col-sm-12 form-group">
                            ...
                            <div class="input-group">
                                <select class="js-example-basic-single col-sm-12" name="customer" id="kategori-produk">
                        ...
                        <div class="col-sm-12 form-group">
                            ...
                            <input type="text" class="form-control form-control-sm harga-produk"
                                ...
                                placeholder="Input harus angka" name="debit" />
                        ...
                        <div class="col-sm-12 form-group">
                            ...
                            <input type="text" class="form-control form-control-sm harga-produk"
                                oninput="this.value = this.value.replace(/[^0-9]/g, '');"
                                placeholder="Input harus angka" name="kredit" />
                            @error('kredit')
                            <svg aria-hidden="true" class="stUf5b LxE1Id" fill="currentColor" focusable="false"
                                width="16px" height="16px" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
                                <path
                        ...
                        <div class="col-sm-12 form-group">
                            ...
                            <input type="text" class="form-control form-control-sm nama-produk" name="keterangan" />
                            <div class="text-err">
                                @error('keterangan')
                                <svg aria-hidden="true" class="stUf5b LxE1Id" fill="currentColor" focusable="false"
                                    width="16px" height="16px" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
...
<div class="container-f">
    ...
    <div class="content">
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" style="background-color: yellow">
                            <a href="{{ route('pinjaman.edit', $value->id) }}"
                                style="color: black;text-decoration-line: none">edit</a>
                        </button>
                        <form method="post" action="{{route('pinjaman.destroy', $value->id)}}"
        ...
        {{ $pinjaman->appends(request()->input())->links() }}
    </div>
</div>
@endsection
