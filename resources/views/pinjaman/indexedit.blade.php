                ...
                <div class="row">
                        ...
                        <div class="input-group">
                            <select class="js-example-basic-single col-sm-12" name="customer" id="kategori-produk">
                                ...
                                @foreach ($customer as $item)
                                    @if ($item->id == $pinjaman->customer_id)
                    ...
                    <div class="col-sm-12 form-group">
                        ...
                        <input type="text" class="form-control form-control-sm harga-produk"
                            ...
                            placeholder="Input harus angka" name="debit" value="{{$pinjaman->debit}}"/>
                    ...
                    <div class="col-sm-12 form-group">
                        ...
                        <input type="text" class="form-control form-control-sm harga-produk"
                            oninput="this.value = this.value.replace(/[^0-9]/g, '');"
                            placeholder="Input harus angka" name="kredit" value="{{$pinjaman->kredit}}"/>
                        @error('kredit')
                        <svg aria-hidden="true" class="stUf5b LxE1Id" fill="currentColor" focusable="false"
                            width="16px" height="16px" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
                            <path
                    ...
                    <div class="col-sm-12 form-group">
                        ...
                        <input type="text" class="form-control form-control-sm tanggal-produk" id="my_date_picker"
                            name="tanggal" autocomplete="off" value="{{date('d-m-Y', $pinjaman->tanggal)}}"/>
                        <div class="text-err">
                            @error('tanggal')
                            <svg aria-hidden="true" class="stUf5b LxE1Id" fill="currentColor" focusable="false"
                                width="16px" height="16px" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
