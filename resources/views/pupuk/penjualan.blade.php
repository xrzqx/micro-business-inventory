                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12 form-group">
                            ...
                            <input type="text" class="form-control form-control-sm invoice-produk"
                                ...
                                placeholder="input harus angka" name="invoice" />
                            @error('invoice')
                            ...
                            <div class="input-group">
                                <select class="js-example-basic-single col-sm-12" name="customer" id="nama-customer">
                                    ...
                                    @foreach ($customer as $value)
                                        <option value="{{ $value->id }}">{{ $value->nama }} | {{ $value->nik }} | {{$value->lokasi}}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('customer')
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 form-group">
                            ...
                            placeholder="Input harus angka" name="hargaDynamic[]" id="hargaInp" />
                            @error('hargaDynamic[]')
                            <svg aria-hidden="true" class="stUf5b LxE1Id" fill="currentColor" focusable="false"
                                width="16px" height="16px" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
                                <path
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" style="background-color: lightgreen">
                            <a href="{{ route('pupukpenjualan.invoice', $value->id) }}"
                                style="color: black;text-decoration-line: none">PDF</a>
                        </button>
        ...
        $("#addButton").click(function () {
            var dynamicContent = `
                <div class="row">
                    ...
                    <div class="col-sm-3 form-group">
                        <label>Harga (kg)</label>
                        <input type="text" class="form-control form-control-sm harga-produk-`+counter+`" 
                        oninput="validateInputHarga(this)"
                        placeholder="Input harus angka" name="hargaDynamic[]" id="hargaInp-`+counter+`" />
                        @error('hargaDynamic[]')
                        <svg aria-hidden="true" class="stUf5b LxE1Id" fill="currentColor" focusable="false"
                            width="16px" height="16px" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
                            <path
