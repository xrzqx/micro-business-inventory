...
<div class="modal fade modal-item" id="kategoriModalCenter" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('pupukkategori.store') }}">
                @csrf
...
<div class="container-f">
    <div class="sidenav">
        <ul class="main-list">
            ...
            <ul class="sublist">
                ...
                <li class="sublist-item selected"><a href="{{route('pupukkategori.index')}}">Daftar Kategori</a></li>
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <form class="d-flex" action="{{route('pupukkategori.search')}}" method="GET">
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" style="background-color: yellow">
                            <a href="{{ route('pupukkategori.edit', $item->id) }}"
                                style="color: black;text-decoration-line: none">edit</a>
                        </button>
                        <form method="post" action="{{ route('pupukkategori.destroy', $item->id) }}"
