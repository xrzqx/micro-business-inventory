...
<div class="container-f">
    <div class="sidenav">
        <ul class="main-list">
            ...
            <ul class="sublist">
                ...
                <li class="sublist-item selected"><a href="{{route('pupukpembelian.index')}}">Pembelian</a></li>
    ...
    <div class="content">
        ...
        @endif
        <form method="POST" action="{{route('pupukpembelian.update', $pembelian[0]->id)}}">
            @csrf
            @method('POST')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 form-group">
                        ...
                        <input type="text" class="form-control form-control-sm harga-produk"
                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                            placeholder="input harus angka" name="harga" value="{{$pembelian[0]->harga / $pembelian[0]->jumlah}}"/>
                        @error('harga')
                        <svg aria-hidden="true" class="stUf5b LxE1Id" fill="currentColor" focusable="false" width="16px"
                            height="16px" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
                            <path
            ...
            <div class="row-12">
                <div class="col-12">
                    <button type="button" class="btn btn-secondary">
                        <a href="{{route('pupukpembelian.index')}}" style="color: white; text-decoration-line: none">back</a>
                    </button>
