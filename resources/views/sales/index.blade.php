    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title exampleModalLabel" id="kategoriModalLabel">Tambah Sales</h5>
            </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12 form-group">
                            ...
                            <input type="text" class="form-control form-control-sm nama-produk" name="sales" />
                            <div class="text-err">
                                @error('sales')
...
<div class="container-f">
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <form class="d-flex" action="{{route('sales.search')}}" method="GET">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" name="namasales" value="{{ request('search') }}"
