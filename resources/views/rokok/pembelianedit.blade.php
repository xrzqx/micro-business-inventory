...
<div class="container-f">
    ...
    <div class="content">
        ...
        @endif
        <form method="POST" action="{{route('rokokpembelian.update', $pembelian[0]->id)}}">
            @csrf
            @method('POST')
            ...
            <div class="row-12">
                <div class="col-12">
                    <button type="button" class="btn btn-secondary">
                        <a href="{{route('rokokpembelian.index')}}" style="color: white; text-decoration-line: none">back</a>
                    </button>
