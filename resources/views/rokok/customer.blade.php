...
<div class="modal fade modal-item" id="kategoriModalCenter" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('rokokcustomer.store') }}">
                @csrf
...
<div class="container-f">
    <div class="sidenav">
        <ul class="main-list">
            ...
            <ul class="sublist">
                <li class="sublist-item selected"><a href="{{route('rokokcustomer.index')}}">Daftar Customer</a></li>
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" style="background-color: yellow">
                            <a href="{{ route('rokokcustomer.edit', $item->id) }}"
                                style="color: black;text-decoration-line: none">edit</a>
                        </button>
                        <form method="post" action="{{ route('rokokcustomer.destroy', $item->id) }}"
