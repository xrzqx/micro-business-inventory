...
<div class="modal fade modal-item" id="kategoriModalCenter" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('minyakcustomer.store') }}">
                @csrf
...
<div class="container-f">
    <div class="sidenav">
        <ul class="main-list">
            ...
            <ul class="sublist">
                <li class="sublist-item selected"><a href="{{route('minyakcustomer.index')}}">Daftar Customer</a></li>
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <form class="d-flex" action="{{route('motorcustomer.search')}}" method="GET">
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" style="background-color: yellow">
                            <a href="{{ route('minyakcustomer.edit', $item->id) }}"
                                style="color: black;text-decoration-line: none">edit</a>
                        </button>
                        <form method="post" action="{{ route('minyakcustomer.destroy', $item->id) }}"
