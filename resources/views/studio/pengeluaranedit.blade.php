...
<div class="container-f">
    <div class="sidenav">
        <ul class="main-list">
            ...
            <ul class="sublist">
                ...
                <li class="sublist-item selected"><a href="{{route('studiopengeluaran.index')}}">Pengeluaran</a></li>
    ...
    <div class="content">
        ...
        @endif
        <form method="POST" action="{{route('studiopengeluaran.update', $pengeluaran->id)}}">
            @csrf
            @method('POST')
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 form-group">
                        ...
                        <input type="text" class="form-control form-control-sm nama-produk" name="nama" value="{{$pengeluaran->nama}}"/>
                        <div class="text-err">
                            @error('nama')
                    ...
                    <div class="col-sm-12 form-group">
                        ...
                        <input type="text" class="form-control form-control-sm harga-produk"
                            ...
                            placeholder="input harus angka" name="harga" value="{{$pengeluaran->harga}}"/>
                        @error('harga')
                    ...
                    <div class="col-sm-12 form-group">
                        ...
                        <input type="text" class="form-control form-control-sm tanggal-produk" id="my_date_picker"
                            name="tanggal" value="{{date('d-m-Y', $pengeluaran->tanggal)}}"/>
                        <div class="text-err">
                            @error('tanggal')
                            <svg aria-hidden="true" class="stUf5b LxE1Id" fill="currentColor" focusable="false"
                                width="16px" height="16px" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
            ...
            <div class="row-12">
                <div class="col-12">
                    <button type="button" class="btn btn-secondary">
                        <a href="{{route('studiopengeluaran.index')}}" style="color: white; text-decoration-line: none">back</a>
                    </button>
