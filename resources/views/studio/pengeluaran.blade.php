    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title exampleModalLabel" id="kategoriModalLabel">Tambah Pengeluaran</h5>
            </div>
            <form method="POST" action="{{ route('studiopengeluaran.store') }}">
                @csrf
...
<div class="container-f">
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <form class="d-flex" action="{{route('studiopengeluaran.search')}}" method="GET">
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" style="background-color: yellow">
                            <a href="{{ route('studiopengeluaran.edit', $value->id) }}"
                                style="color: black;text-decoration-line: none">edit</a>
                        </button>
                        <form method="post" action="{{ route('studiopengeluaran.destroy', $value->id) }}"
        ...
        {{ $pengeluaran->appends(request()->input())->links() }}
    </div>
</div>
@endsection
