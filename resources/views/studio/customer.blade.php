...
<div class="modal fade modal-item" id="kategoriModalCenter" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('studiocustomer.store') }}">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12 form-group">
                            <label>Nama Customer</label>
                            <input type="text" class="form-control form-control-sm nama-produk" name="namacustomer" />
                            <div class="text-err">
                                @error('namacustomer')
                        ...
                        <div class="col-sm-12 form-group">
                            <label>Nomor</label>
                            <input type="text" class="form-control form-control-sm nomor-produk" 
                            oninput="validateNumber(this)" placeholder="Input harus angka" name="nomor" 
...
<div class="container-f">
    <div class="sidenav">
        <ul class="main-list">
            ...
            <ul class="sublist">
                <li class="sublist-item selected"><a href="{{route('studiocustomer.index')}}">Daftar Customer</a></li>
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <form class="d-flex" action="{{route('studiocustomer.search')}}" method="GET">
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" style="background-color: yellow">
                            <a href="{{ route('studiocustomer.edit', $item->id) }}"
                                style="color: black;text-decoration-line: none">edit</a>
                        </button>
                        <form method="post" action="{{ route('studiocustomer.destroy', $item->id) }}"
