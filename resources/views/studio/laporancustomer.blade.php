...
<div class="container-f">
    <div class="sidenav">
        <ul class="main-list">
            ...
            <ul class="sublist">
                ...
                <li class="sublist-item selected"><a href="{{route('studiolaporancustomer.index')}}">Laporan Customer</a></li>
    ...
    <div class="content">
        <h1>Laporan Penjualan Customer</h1>
        <div class="row">
            <div class="col-sm-6">
                <form class="d-flex" action="{{route('studiolaporancustomer.search')}}" method="GET">
