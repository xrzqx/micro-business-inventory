...
<div class="container-f">
    <div class="sidenav">
        <ul class="main-list">
            ...
            <ul class="sublist">
                ...
                <li class="sublist-item selected"><a href="{{route('brilinkkeuangan.index')}}">Laporan Keuangan</a></li>
            </ul>
            <li class="toggle-sublist">
                <div class="flex-row-list">
                    <span>Pupuk</span>
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-sm-6">
                <form class="d-flex" action="{{route('brilinkkeuangan.search')}}" method="GET">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    @foreach ($data as $value)
                        <tr>
                            <td>{{ ++$no }}</td>
                            <td>Transfer {{$value->bank->nama}}</td>
                            <td>{{$value->kredit + $value->total_admin}}</td>
                            <td>{{$value->kredit}}</td>
                        </tr>
                        @php
                            $totalDebit += $value->kredit + $value->total_admin;
