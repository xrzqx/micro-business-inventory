...
<div class="container-f">
    <div class="sidenav">
        <ul class="main-list">
            ...
            <ul class="sublist">
                ...
                <li class="sublist-item selected"><a href="{{route('motorlaporanlabakategori.index')}}">Laporan Laba (Category Wise)</a></li>
    ...
    <div class="content">
        ...
        <form class="d-flex" action="{{route('motorlaporanlabakategori.search')}}" method="GET">
