...
<div class="container-f">
    <div class="sidenav">
        <ul class="main-list">
            ...
            <ul class="sublist">
                ...
                <li class="sublist-item selected"><a href="{{route('motorpengeluaran.index')}}">Pengeluaran</a></li>
    ...
    <div class="content">
        ...
        @endif
        <form method="POST" action="{{route('motorpengeluaran.update', $pengeluaran->id)}}">
            @csrf
            @method('POST')
            ...
            <div class="row-12">
                <div class="col-12">
                    <button type="button" class="btn btn-secondary">
                        <a href="{{route('motorpengeluaran.index')}}" style="color: white; text-decoration-line: none">back</a>
                    </button>
