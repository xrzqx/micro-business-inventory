...
<div class="container-f">
    <div class="sidenav">
        <ul class="main-list">
            ...
            <ul class="sublist">
                ...
                <li class="sublist-item selected"><a href="{{route('motorlaporancustomer.index')}}">Laporan Customer</a></li>
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-sm-6">
                <form class="d-flex" action="{{route('motorlaporancustomer.search')}}" method="GET">
