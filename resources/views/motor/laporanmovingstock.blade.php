...
<div class="container-f">
    <div class="sidenav">
        <ul class="main-list">
            ...
            <ul class="sublist">
                ...
                <li class="sublist-item selected"><a href="{{route('motorlaporanmovingstock.index')}}">Laporan Moving Stock</a></li>
    ...
    <div class="content">
        <h1>Laporan Moving Stock</h1>
        <form class="d-flex" action="{{route('motorlaporanmovingstock.search')}}" method="GET">
