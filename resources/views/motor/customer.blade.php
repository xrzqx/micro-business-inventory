...
<div class="modal fade modal-item" id="kategoriModalCenter" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('motorcustomer.store') }}">
                @csrf
...
<div class="container-f">
    <div class="sidenav">
        <ul class="main-list">
            ...
            <ul class="sublist">
                <li class="sublist-item selected"><a href="{{route('motorcustomer.index')}}">Daftar Customer</a></li>
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" style="background-color: yellow">
                            <a href="{{ route('motorcustomer.edit', $item->id) }}"
                                style="color: black;text-decoration-line: none">edit</a>
                        </button>
                        <form method="post" action="{{ route('motorcustomer.destroy', $item->id) }}"
