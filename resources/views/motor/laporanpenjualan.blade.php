...
<div class="container-f">
    <div class="sidenav">
        <ul class="main-list">
            ...
            <ul class="sublist">
                ...
                <li class="sublist-item selected"><a href="{{route('motorlaporanpenjualan.index')}}">Laporan Penjualan</a></li>
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-sm-6">
                <form class="d-flex" action="{{route('motorlaporanpenjualan.search')}}" method="GET">
        ...
        <table style="margin-left: 0.5rem">
            ...
            <tr>
                ...
                <td><strong style="margin-left: 0.5rem">{{ number_format($rate, 2) }}%</strong></td>
            </tr>
        </table>
    </div>
</div>
