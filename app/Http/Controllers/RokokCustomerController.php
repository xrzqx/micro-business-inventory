...
class RokokCustomerController extends Controller
{
    //
    /**
    ...
    {
        $customer = Customer::where('module', '=', 'rokok')->paginate(7);
        return view("rokok.customer", 
        [
            "customer" => $customer,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('rokokcustomer.index')->with('success', 'menambahkan kategori');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('rokok.customeredit', 
        [
            "customer" => $customer,
        ]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('rokokcustomer.index')->with('success', 'mengubah kategori');
    }
    ...
    public function destroy(string $id)
    {
        ...
        $customer->delete();
        return redirect()->route('rokokcustomer.index')->with('success', 'menghapus kategori');
    }
    ...
    public function search(Request $request)
    {
        ...
        $customer = Customer::where('module', '=', 'rokok')
