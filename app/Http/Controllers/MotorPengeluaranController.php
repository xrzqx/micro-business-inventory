...
class MotorPengeluaranController extends Controller
{
    //
    public function index(){
        $pengeluaran = Pengeluaran::where('toko','motor')->paginate(7);
        // return $pengeluaran;
        return view('motor.pengeluaran',[
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('motorpengeluaran.index')->with('success', 'menambahkan pengeluaran');
    }
    ...
    { 
        ...
        return view('motor.pengeluaranedit', 
        [
            "pengeluaran" => $pengeluaran,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('motorpengeluaran.index')->with('success', 'mengedit pengeluaran');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('motorpengeluaran.index')->with('success', 'menghapus pengeluaran');
    }
