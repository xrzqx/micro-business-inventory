...
class PupukBarangController extends Controller
{
    //
    public function index(){
        $barang = Barang::with('item', 'kategori')
            ...
            ->paginate(7);
        $kategori = Kategori::all()->where('toko', '=', 'pupuk');
        // $barang = Item::all();
        return view("pupuk.barang", 
        [
            "barang" => $barang,
            "kategori" => $kategori,
        ]);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pupuk.index')->with('success', 'menambahkan barang');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('pupuk.index')->with('success', 'mengubah barang');
    }
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return redirect()->route('pupuk.index')->with('failed', 'menghapus barang');
        }
        return redirect()->route('pupuk.index')->with('success', 'menghapus barang');
    }
