...
class RokokPenjualanController extends Controller
{
    //
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('rokokpenjualan.index')->with('success', 'menambahkan penjualan barang');
    }
    ...
    public function edit($id)
    {
        ...
        return $penjualan;
        return view('rokok.penjualanedit', 
        [
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('rokokpenjualan.index')->with('success', 'mengubah penjualan barang');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('rokokpenjualan.index')->with('success', 'menghapus penjualan barang');
    }
