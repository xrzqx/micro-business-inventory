...
class RokokPembelianController extends Controller
{
    //
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('rokokpembelian.index')->with('success', 'menambahkan pembelian barang');
    }
    ...
    public function edit($id)
    {
        ...
        return view('rokok.pembelianedit', 
        [
            "barang" => $barang,
            "pembelian" => $pembelian,
        ]);
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('rokokpembelian.index')->with('success', 'menghapus pembelian barang');
    }
