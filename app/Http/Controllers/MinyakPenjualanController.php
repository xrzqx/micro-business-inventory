...
class MinyakPenjualanController extends Controller
{
    //
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('minyakpenjualan.index')->with('success', 'menambahkan penjualan barang');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('minyakpenjualan.index')->with('success', 'mengubah penjualan barang');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('minyakpenjualan.index')->with('success', 'menghapus penjualan barang');
    }
