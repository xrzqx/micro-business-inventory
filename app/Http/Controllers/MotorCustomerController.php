...
class MotorCustomerController extends Controller
{
    //
    /**
    ...
    {
        $customer = Customer::where('module', '=', 'SGH_Motor')->paginate(7);
        return view("motor.customer", 
        [
            "customer" => $customer,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('motorcustomer.index')->with('success', 'menambahkan kategori');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('motor.customeredit', 
        [
            "customer" => $customer,
        ]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('motorcustomer.index')->with('success', 'mengubah kategori');
    }
    ...
    public function destroy(string $id)
    {
        ...
        $customer->delete();
        return redirect()->route('motorcustomer.index')->with('success', 'menghapus kategori');
    }
