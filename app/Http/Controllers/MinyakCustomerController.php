...
class MinyakCustomerController extends Controller
{
    //
    /**
    ...
    {
        $customer = Customer::where('module', '=', 'minyak')->paginate(7);
        return view("minyak.customer", 
        [
            "customer" => $customer,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('minyakcustomer.index')->with('success', 'menambahkan kategori');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('minyak.customeredit', 
        [
            "customer" => $customer,
        ]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('minyakcustomer.index')->with('success', 'mengubah kategori');
    }
    ...
    public function destroy(string $id)
    {
        ...
        $customer->delete();
        return redirect()->route('minyakcustomer.index')->with('success', 'menghapus kategori');
    }
    ...
    public function search(Request $request)
    {
        ...
        $customer = Customer::where('module', '=', 'minyak')
