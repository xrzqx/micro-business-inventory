...
class MinyakPembelianController extends Controller
{
    //
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('minyakpembelian.index')->with('success', 'menambahkan pembelian barang');
    }
    ...
    public function edit($id)
    {
        ...
        return view('minyak.pembelianedit', 
        [
            "barang" => $barang,
            "pembelian" => $pembelian,
        ]);
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('minyakpembelian.index')->with('success', 'menghapus pembelian barang');
    }
