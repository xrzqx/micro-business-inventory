...
class PupukPembelianController extends Controller
{
    //
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pupukpembelian.index')->with('success', 'menambahkan pembelian barang');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pupuk.pembelianedit', 
        [
            "barang" => $barang,
            "pembelian" => $pembelian,
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $pembelian->harga = $total_harga;
        $pembelian->tanggal = $timestamp;
        $pembelian->save();

        return redirect()->route('pupukpembelian.index')->with('success', 'mengedit pembelian barang');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('pupukpembelian.index')->with('success', 'menghapus pembelian barang');
    }
